...
\begin{enumerate}[label=\arabic*.]
    \item Bộ môn Công nghệ Phần mềm, Khoa CNTT \& TT, Đại học Cần Thơ, \textit{Mẫu Tài liệu Đặc tả Yêu cầu Phần mềm (SRS)}.
    % \item Nhóm 1, \textit{Đề tài Niên luận ngành KTPM: Xây dựng nền tảng kết nối tuyển dụng và hỗ trợ viết CV thông minh tích hợp AI (SmartHire)}, 2026.
    \item Microsoft, \textit{ASP.NET Core Web API Documentation \& JWT Authentication Guidelines}, 2026. Truy cập tại: \url{https://learn.microsoft.com/aspnet/core/}.
    \item PostgreSQL Global Development Group, \textit{PostgreSQL 16 Documentation: Data Types and JSONB}, 2026. Truy cập tại: \url{https://www.postgresql.org/docs/16/}.
    \item React Team, \textit{React Documentation}; TanStack, \textit{TanStack Query Documentation}, 2026. Truy cập tại: \url{https://react.dev/} và \url{https://tanstack.com/query/latest}.
\end{enumerate}
